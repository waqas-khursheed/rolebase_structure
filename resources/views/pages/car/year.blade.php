      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
              ...
              <!-- form start -->
                <form role="form" id="quickForm" method="POST" action="{{URL::to('year')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Year" name="year" required="" autofocus>
                            @if ($errors->has('year'))
                    ...
                    @foreach ($year as $item)
                        ...
                        <div class="modal fade" id="delete{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="delete{{$item->id}}Label" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form id="car-form" action="{{ URL::to('year/'.$item->id) }}" Method="post" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body"> 
                                        <div class="container">
                                            <form id="form_validation" method="POST" action="{{URL::to('year/'.$item->id)}}">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group ">
                                                    <input type="number" class="form-control" placeholder="Year" name="year" required="" autofocus value="{{$item->year}}">
                                                </div>
                                                <br>
